...
export utility_pkgs="$pkgs_dir/utility_pkgs"
...
export monitoring_pkgs="$pkgs_dir/monitors_pkgs"
export kde_pkgs="$pkgs_dir/kde_pkgs"
export gnome_pkgs="$pkgs_dir/gnome_pkgs"
export xfce_pkgs="$pkgs_dir/xfce_pkgs"
export cinnamon_pkgs="$pkgs_dir/cinnamon_pkgs"
...
export nodejs_pkgs="$pkgs_dir/node_pkgs"
